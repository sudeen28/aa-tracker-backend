  ...
  try {
    ...
    const booking = await prisma.booking.create({
      data: {
        ...
        seatConfig: seatConfig ? { create: { aircraft: seatConfig.aircraft, flightLabel: seatConfig.flightLabel, selectedSeat: seatConfig.selectedSeat, sections: seatConfig.sections, occupied: seatConfig.occupied, exits: seatConfig.exits } } : undefined,
